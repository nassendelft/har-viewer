...
publishing {
    publications.withType<MavenPublication>().all {
        ...
        pom {
            ...
            url.set("https://github.com/nassendelft/har-viewer/")
            ...
            scm {
                connection = "scm:git:git://github.com/nassendelft/har-viewer.git"
                developerConnection = "scm:git:ssh://github.com/nassendelft/har-viewer.git"
                url = "https://github.com/nassendelft/har-viewer"
            }
        }
    }
}
...
publishing.publications.withType<MavenPublication>().all {
    ...
    publishAllPublicationsToSonatype.configure { dependsOn(publishTask) }
}
...
publishing {
    repositories {
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/nassendelft/har-viewer")
            credentials {
